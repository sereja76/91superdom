    ...
    <body>
        ...
        <div class="wrapper-page">
          ...
          <div class="m-t-40 card-box">
                <div class="text-center">
                    <h4 class="text-uppercase font-bold m-b-0">Добавление нового автора</h4>
                </div>
                <div class="p-20">
                    <form class="form-horizontal m-t-20" action="admin/autor_add"  method="post">
                        ...
                        <div class="form-group text-center m-t-30">
                            <div class="col-xs-12">
                                <button class="btn btn-custom btn-bordred btn-block waves-effect waves-light" type="submit">Добавить нового автора</button>
                            </div>
                        </div>
