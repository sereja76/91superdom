    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class="text-center">
                <a href="<?=base_url()?>" class="logo"><span>Сервис<span> Теоретик</span></span></a>
          ...
          <div class="m-t-40 card-box">
                ...
                <div class="p-20">
                    <form class="form-horizontal m-t-20" action="auth/create_user"  method="post">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input type="password" name="password" value="" id="password" class="form-control" placeholder="Пароль"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group text-center m-t-30">
                            <div class="col-xs-12">
                                <button class="btn btn-custom btn-bordred btn-block waves-effect waves-light" type="submit">Зарегистрироваться</button>
                            </div>
                        </div>
