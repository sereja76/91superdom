                ...
                <div class="p-20">
                    <form class="form-horizontal m-t-20" action="auth/login" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" name="identity" id="identity" type="text" required="" placeholder="Email">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" type="password" required="" name="password" value="" id="password" placeholder="Пароль">
                            </div>
                        </div>
