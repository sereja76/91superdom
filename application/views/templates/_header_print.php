        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="<?=base_url()?>" class="logo"><span>Заочник<span> </span></span><i class="mdi mdi-layers"></i></a>
                </div>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                          <li class="text-muted menu-title">Меню</li>
                            <li>
                                <a href="autor/data" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Профиль </span> </a>
                            </li>
                            
                            <li>
                                <a href="autor/orders" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Заказы </span> </a>
                            </li>
