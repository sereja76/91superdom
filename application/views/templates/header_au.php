                    ...
                    <div id="sidebar-menu">
                        <ul>
                          <li class="text-muted menu-title">Меню</li>
                            ...
                            <li>
                                <a href="autor/orders" class="waves-effect"><i class="fa fa-shopping-basket"></i> <span> Заказы </span> </a>
                            </li>
							
							<li>
                                <a href="autor/data" class="waves-effect"><i class="fa fa-vcard-o"></i> <span> Профиль </span> </a>
                            </li>                         
