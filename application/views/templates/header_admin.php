        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="<?=base_url()?>" class="logo"><span>Теоретик<span> </span></span><i class="mdi mdi-layers"></i></a>
                </div>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                          <li class="text-muted menu-title">Меню</li>
                            ...
                            <li>
                                <a href="admin/index" class="waves-effect"><i class="mdi mdi-view-dashboard"></i> <span> Главная </span> </a>
                            </li>

                            <li>
                                <a href="admin/users" class="waves-effect"><i class="fa fa-users"></i> <span> Клиенты </span> </a>
                            </li>
                            
                            <li>
                                <a href="admin/autors" class="waves-effect"><i class="fa fa-font"></i> <span> Авторы </span> </a>
                            </li>

                            <li>
                                <a href="admin/orders" class="waves-effect"><i class="fa fa-shopping-basket"></i> <span> Заказы </span> </a>
                            </li>
